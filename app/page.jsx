...
function MySessions({ go, user, status }) {
  ...
  // Helper to check for other bookings on a date (excluding the one being rescheduled)
  ...
  return (
    <div className="page my-sessions-page"><div className="wrap my-sessions-wrap">
      ...
      <div className="my-sessions-actions" style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12, marginBottom: 32 }}>
        ...
        <a
          ...
          style={{
            ...
            color: "#f3ece1", cursor: "pointer", WebkitAppearance: "none", textDecoration: "none"
          }}
        >
      ...
      {/* Next Session - featured card only */}
                    ...
                    {calendarDays.map(({ date, outside }, i) => {
                      ...
                      return (
                        <button key={i} onClick={() => hasAvail && setSelectedDate(isoD)} disabled={!hasAvail} style={{
                          ...
                          {date.getUTCDate()}
                          {/* Green dot for days with other bookings */}
                      ...
                      <div style={{
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 12, color: "#f3ece1", lineHeight: 1.4 }}>
                            {getOtherBookingsForDate(selectedDate).map((b, idx) => (
                              <div key={b.id}>
